...
namespace SFA.DAS.Funding.ApprenticeshipPayments.Command.UnitTests
{
    public class ProcessUnfundedPaymentsCommandHandler_ProcessTests
    {
        ...
        public async Task Setup()
        {
            ...
            _eventBuilder.Setup(x => x.Build(It.IsAny<PaymentEntityModel>(), It.IsAny<Guid>(), It.IsAny<short>())).Returns(_expectedEvent);
        ...
        {
            _eventBuilder.Verify(x => x.Build(It.Is<PaymentEntityModel>(y => y.Amount == 100), It.IsAny<Guid>(), It.IsAny<short>()));
            _eventBuilder.Verify(x => x.Build(It.Is<PaymentEntityModel>(y => y.Amount != 100), It.IsAny<Guid>(), It.IsAny<short>()), Times.Never);
        }
