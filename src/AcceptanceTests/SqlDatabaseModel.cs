...
public static class SqlDatabaseModel
{
    ...
    public const string DatabaseProjectName = "SFA.DAS.Funding.ApprenticeshipPayments.Database";
    ...
    private static void SetDacpacLocation()
    {
        ...
        _dacpacFileLocation = Path.Combine(
            ...
            "src", "SFA.DAS.Funding.ApprenticeshipPayments.Database", "bin", environment, $"{DatabaseProjectName}.dacpac");
