...
public class ApprenticeshipEntity_UnfreezeTests
{
    ...
    public void SetUp()
    {
        ...
        _sut = new ApprenticeshipEntity(Mock.Of<ICalculateApprenticeshipPaymentsCommandHandler>(), Mock.Of<IProcessUnfundedPaymentsCommandHandler>(), Mock.Of<IRecalculateApprenticeshipPaymentsCommandHandler>(), Mock.Of<ILogger<ApprenticeshipEntity>>());
